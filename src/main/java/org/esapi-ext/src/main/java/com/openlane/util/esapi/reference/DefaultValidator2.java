 ...
 */
public class DefaultValidator2 extends DefaultValidator {
    public static int MAX_REDIRECT_URL_LENGTH = 2048;
    private static final Logger log = LoggerFactory.getLogger(DefaultValidator2.class);
    ...
    public static Validator getInstance() {
        if ( instance == null ) {
            synchronized ( Validator.class ) {
                if ( instance == null ) {
                    instance = new DefaultValidator2();
                }
            }
        }
        return instance;
    ...
    public DefaultValidator2() {
        this.encoder = ESAPI2.encoder2();
        log.info("encoder: " + this.encoder.getClass().getName());
        if (this.encoder instanceof DefaultEncoder2) {
            DefaultEncoder2 de2 = (DefaultEncoder2) this.encoder;
            Iterator i = de2.getCodecs().iterator();
            StringBuilder sb = new StringBuilder("Default Validator2 using below codec: ");
            while (i.hasNext()) {
                Codec codec = (Codec) i.next();
                sb.append(codec.getClass().getName()).append(" : ");
            }
    ...
    public boolean isValidRedirectLocation(String context, String input, boolean allowNull) throws IntrusionException {
        return isValidInput(context, input, context, MAX_REDIRECT_URL_LENGTH, allowNull);
    }
    ...
    public boolean isValidRedirectLocation(String context, String input, boolean allowNull, ValidationErrorList errors) throws IntrusionException {
        return isValidInput(context, input, context, MAX_REDIRECT_URL_LENGTH, allowNull, errors);
    }
    ...
    public String getValidRedirectLocation(String context, String input, boolean allowNull) throws ValidationException, IntrusionException {
        return getValidInput(context, input, context, MAX_REDIRECT_URL_LENGTH, allowNull);
    ...
    static {
        ...
        list.add( "HTMLEntityCodec2" );
        list.add( "PercentCodec" );
        Encoder fileEncoder = new DefaultEncoder2( list );
        fileValidator = new DefaultValidator2( fileEncoder );
    }
     ...
     * @param encoder
     */
    public DefaultValidator2( Encoder encoder ) {
