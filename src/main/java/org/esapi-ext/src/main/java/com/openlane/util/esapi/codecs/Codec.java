 ...
 */
public abstract class Codec extends org.owasp.esapi.codecs.Codec {
	...
	public String decode(String input) {
		StringBuilder sb = new StringBuilder();
		org.owasp.esapi.codecs.PushbackString pbs = new org.owasp.esapi.codecs.PushbackString(input);
		while (pbs.hasNext()) {
	 ...
	 */
	 public Character decodeCharacter(org.owasp.esapi.codecs.PushbackString input ) {
	 	return input.next();
	 }
